...
\begin{itemize}
\item BEKAKRIA Ahmed : Étudiant n°22412063, collecte des données, requêtes SQL, analyse et visualisation des données
...
corrélation_idh <- as.data.frame(sapply(corrélation_idh, as.numeric))

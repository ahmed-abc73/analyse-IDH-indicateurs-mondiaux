...
```{sql connection = con, output.var = "pib_moy"}
...
```{sql connection = con, output.var = "idh_top10"}
...
```{sql connection = con, output.var = "espe_vie"}
...
```{sql connection = con, output.var = "ide_pib"}
...
```{sql connection = con, output.var = "corruption_data"}
...
```{sql connection = con, output.var = "idh_2018", include=FALSE}
...
```{sql connection = con, output.var = "idh_2021", include=FALSE}
...
```{sql connection = con, output.var = "chomage2018", include=FALSE}
...
```{sql connection = con, output.var = "chomage2021", include=FALSE}
...
```{sql connection = con, output.var = "corrélation_idh", include=FALSE}
SELECT DISTINCT
    Développement.idh, 
...
```{sql connection = con, output.var = "pib_santé", include=FALSE}
...
```{sql connection = con, output.var = "nb_pays_par_continent", include=FALSE}
...
```{sql connection = con, output.var = "pib_2018", include=FALSE}
